...
class HomePageNewUser extends StatefulWidget {
  ...
  HomePageNewUser({this.user});

  @override
  HomePageState createState() => HomePageState();
}

class HomePageState extends State<HomePageNewUser> {
  ...
  Widget build(BuildContext context) {
    ...
    res_data = bloc.loadRecommendedMoviesNewUser(
        widget.user.userId, widget.user.favorite);
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ListMovies("recommend_for_you",
                        snapshot.data['recommendations'].cast<int>()),
                    TitleOfList("Popularity movies",
                        snapshot.data['popularity'].cast<int>()),
                    ListMovies("popularity_movies",
                        snapshot.data['popularity'].cast<int>()),
  ...
  Widget PageViewHeader(BuildContext context) {
    List<Future<Movie>> list_movies =
        bloc.loadMovies([271110, 68721, 58233, 49530]);
    return Container(
      width: double.infinity,
